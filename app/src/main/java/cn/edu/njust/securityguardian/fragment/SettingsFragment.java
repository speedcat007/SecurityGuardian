...
public class SettingsFragment extends PreferenceFragment implements Preference.OnPreferenceClickListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        pVersionDetail.setSummary("当前版本：" + AppUtils.getVersionName(getActivity()));
    ...
    private void shareMyApp() {
        ...
        mController.setShareContent("手机卫士，真心不错呀,推荐您使用！.");
...
// 添加微信朋友圈
    ...
    public  void startMarket() {
        Uri uri = Uri.parse(String.format("market://details?id=%s", AppUtils.getPackageInfo(getActivity()).packageName));
